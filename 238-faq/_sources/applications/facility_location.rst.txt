...
In such Weber-type facility location problems, when evaluating tradeoffs using squared Euclidean distances, the formulation becomes a simultaneous minimization of multiple objectives:
